        ...
        <div class="py-4">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex items-center">
                    <a href="{{ route('roles.create') }}" class="btn btn-primary btn-sm bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        {{ __('Create New') }}
                    </a>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex space-x-4">
                                                    <a href="{{ route('roles.show',$role->id) }}" class="text-indigo-600 hover:text-indigo-900">Show</a>
