        ...
        <div class="py-4">
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex items-center">
                    <a href="{{ route('detalle-ventas.create') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex space-x-4">
                                                    <a href="{{ route('detalle-ventas.show', $detalleVenta->id) }}"
                                                        class="text-indigo-600 hover:text-indigo-900">Show</a>
                                                    <a href="{{ route('detalle-ventas.edit', $detalleVenta->id) }}"
                                                        class="text-green-600 hover:text-green-900">Edit</a>
                                                    <form action="{{ route('detalle-ventas.destroy', $detalleVenta->id) }}"
                                                        method="POST"
                                                        onsubmit="return confirm('Are you sure you want to delete this detalle venta?');">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
